...
let sorular = [
    ...
    new Soru("dadf?", { a: "Node.js", b: "Typescript", c: "Npm" }, "c"),
    new Soru("Hangisi afsdffasd paket yönetim uygulasıdır?", { a: "Node.js", b: "Typescript", c: "Npm" }, "c")
]

console.log(sorular[2].soruMetni);

 for(let s of sorular){ 


    setInterval(function(){
        title.innerText = s.soruMetni
    },2000)
